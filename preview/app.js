...
const work1Config = [
  { key: 'hairBack', name: 'hair-back', src: '../assets/native_head_layers/hair_back.png?v=3' },
  { key: 'face', name: 'face', src: '../assets/native_head_layers/face_base.png?v=3' },
  { key: 'browL', name: 'brow-l', src: '../assets/native_head_layers/brow_l.png?v=3' },
  { key: 'browR', name: 'brow-r', src: '../assets/native_head_layers/brow_r.png?v=3' },
  { key: 'eyeL', name: 'eye-l', src: '../assets/native_head_layers/eye_l.png?v=3' },
  { key: 'eyeR', name: 'eye-r', src: '../assets/native_head_layers/eye_r.png?v=3' },
  { key: 'nose', name: 'nose', src: '../assets/native_head_layers/nose.png?v=3' },
  { key: 'mouth', name: 'mouth', src: '../assets/native_head_layers/mouth.png?v=3' },
  { key: 'hairFront', name: 'hair-front', src: '../assets/native_head_layers/hair_front.png?v=3' },
];

const work2Config = [
  { key: 'ribbonsBack', name: 'ribbons-back', src: '../assets/full_body_layers/ribbons_back.png?v=3' },
  { key: 'legLeft', name: 'leg-left', src: '../assets/full_body_layers/leg_left.png?v=3' },
  { key: 'legRight', name: 'leg-right', src: '../assets/full_body_layers/leg_right.png?v=3' },
  { key: 'torso', name: 'torso', src: '../assets/full_body_layers/torso.png?v=3' },
  { key: 'armLeft', name: 'arm-left', src: '../assets/full_body_layers/arm_left.png?v=3' },
  { key: 'armRight', name: 'arm-right', src: '../assets/full_body_layers/arm_right.png?v=3' },
  { key: 'hairBack', name: 'hair-back', src: '../assets/full_body_layers/hair_back.png?v=3' },
  { key: 'face', name: 'face', src: '../assets/full_body_layers/face_base.png?v=3' },
  { key: 'eyeL', name: 'eye-l', src: '../assets/full_body_layers/eye_l.png?v=3' },
  { key: 'eyeR', name: 'eye-r', src: '../assets/full_body_layers/eye_r.png?v=3' },
  { key: 'browL', name: 'brow-l', src: '../assets/full_body_layers/brow_l.png?v=3' },
  { key: 'browR', name: 'brow-r', src: '../assets/full_body_layers/brow_r.png?v=3' },
  { key: 'nose', name: 'nose', src: '../assets/full_body_layers/nose.png?v=3' },
  { key: 'mouth', name: 'mouth', src: '../assets/full_body_layers/mouth.png?v=3' },
  { key: 'hairFront', name: 'hair-front', src: '../assets/full_body_layers/hair_front.png?v=3' },
];
